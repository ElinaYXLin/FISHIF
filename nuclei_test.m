...
%image_folder = '11082010/stacks/11082010_5_hbGP_001/';
image_folder = '11102010/stacks/11102010_1_bcd_004/';
image_type = '*.tif';
WGA_channel = 3;
DAPI_channel = 1;
resolution = 0.09;
...
%% Image analysis/segmentation: %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    bw_DAPI = imerode(bw_DAPI, strel('disk',floor(8/L_ratio)));
...
%%%%% ---------------------------------------------------------------------
    ...
    if size(all_prop(:),1)>0
        WGA_area = floor(0.5*mean([all_prop.Area]));
...
%reform_L = watershed(-bwdist(~reform_all));
reform_all(watershed(-bwdist(~reform_all)) == 0) = 0;
cumulated_all = reform_all | cumulated_all;
