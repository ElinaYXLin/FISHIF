...
%%                   (5) mask_outz: z-spread of spot candidate.
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if length(varargin) >= 2 && ~isempty(varargin{2})   %%% boundary layers that do not need spot detection
    z00 = varargin{2};
else
    z00 = 1;
end
...
if numel(mask_outz) > 1
    N0 = mask_outz(Ipeak);
else
    N0 = mask_outz*ones(size(Ipeak));
end
