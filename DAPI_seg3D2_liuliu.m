function DAPI_seg3D2_liuliu(lf_name)
%clear all
% close all
tic
...
low_th = 400;    %%% lower area limit for circular mask algorithm
...
sigma_th = 50;  %%% neighboring mask threshold correlation decay length for supplemental mask recognition
