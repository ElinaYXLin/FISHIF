function varargout = stack_RNA2(varargin)
% STACK_RNA2 M-file for stack_RNA2.fig
%      STACK_RNA2, by itself, creates a new STACK_RNA2 or raises the existing
%      singleton*.
%
%      H = STACK_RNA2 returns the handle to a new STACK_RNA2 or the handle to
%      the existing singleton*.
%
%      STACK_RNA2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in STACK_RNA2.M with the given input arguments.
%
%      STACK_RNA2('Property','Value',...) creates a new STACK_RNA2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before stack_RNA2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to stack_RNA2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help stack_RNA2

% Last Modified by GUIDE v2.5 12-Jun-2012 10:14:56

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @stack_RNA2_OpeningFcn, ...
                   'gui_OutputFcn',  @stack_RNA2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before stack_RNA2 is made visible.
function stack_RNA2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to stack_RNA2 (see VARARGIN)
...
% Choose default command line output for stack_RNA2
...
% end
% UIWAIT makes stack_RNA2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = stack_RNA2_OutputFcn(hObject, eventdata, handles) 
...
%     mask1D = true(size(imstack,1),size(imstack,2));
%     ELmin = find(mask1D,1);
...
if strcmp(switch_reply,'Yes')
    stack_RNA2_OpeningFcn(hObject, eventdata, handles)
else
