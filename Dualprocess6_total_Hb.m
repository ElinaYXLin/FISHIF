...
embryo_name = {'Hb-hb-gal4-22445-2-1M'};
sub_ij = [3,4];
cycle_range = [9,11,12];%10:12;
cycle_range2 = [9,11,12];%10:12;
rsize0 = 2;
% rsize0 = 3;
nM_con = 1;
Nr = 20;
...
ana_folder = 'Dualprocess6_result/22445-2-1M_FISHIF_hb_gal4_Hb/';
...
%                     beta0 = [-6,0.5,max(ybin0),0];
                    beta0 = [0.2,0.5,max(ybin0),0];
                    try
