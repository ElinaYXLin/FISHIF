...
fit_add = '_spot_fit_new';
fit_add2 = '_spot_fit_new2';
hist_tail = '_raw.xls';
N_thresh = 1;%3
N_thresh2 = 0;
...
% %         flip_EL = EL_orientation(nucleus_DAPI_profile,EL_info,mask_stack,eval(EL_check_name),flip_axis,[],resolution);
        ...
        %     flip_EL=~flip_EL;
        % end
        load([folder_list{list_I,1},flip_folder,sub_list{list_J,3}(1:end-1),flip_add,mat_tail]); 
        %%
        ...
        %[nucleus_protein_profile,cytoplasmic_protein_profile,quanti_p,nucleus_protein_ab] = protein_profile3D2_emmask(nucleus_DAPI_profile,max_image,EL_info,protein_channel,mask_stack,signal_stack,image_folder,N_cycle,resolution,resolutionz,flip_EL,[],[],[],[],[],sigmaxz,flip_axis,EL_range,Inten_protein,tbk0,em_mask,DAPI_stack);
