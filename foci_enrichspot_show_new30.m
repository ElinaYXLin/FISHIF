...
I_plot = [1:17];%[1,2,5,8,9,10];%[3:5,8:11,22:25,27:34];%[3:5,8:11,14:19,22:25,27:34];
I_cycle = 10:12;
epsilon = 1e-4;
smin = 1e-1;
rsize0 = 4;
...
rl = 0:0.1:10; rr = 0.1:0.1:10.1;
el = 0:0.025:0.975; er = 0.025:0.025:1;
tl = -180:5:170; tr = -170:5:180;
xlim1 = [0,0.8];
% ylim1 = [0,0.6];
ylim1 = [0,20];
ylim1b = [0,150];
...
axes('Units','inches','Position',[dsize(1),2*dsize(2)+1*asize(2),asize])
    xdata0 = sqrt(foci_list0(:,2).*foci_list0(:,3));
    id0 = EL_RNA0 >= 0.10 & EL_RNA0 <= 0.35 & dxy0 <= r_th & Sp_en_ratio > smin & Sa_en_ratio > smin;
    id1 = EL_RNA1 >= 0.10 & EL_RNA1 <= 0.35;
    xdata = xdata0(id0);
    ydata = 1./Sa_en(id0)/nnz(id1);%./length(xdata);
    [rm,nar,~] = histw(xdata,ydata,rl,rr);
    
    id0 = EL_RNA0 >= 0.10 & EL_RNA0 <= 0.35 & dxy0 > rout_min & dxy0 <= rout_max & Sp_en_ratio > smin & Sa_en_ratio > smin;
    id1 = EL_RNA1 >= 0.10 & EL_RNA1 <= 0.35;
    xdata = xdata0(id0);
    ydata = 1./Sp_en(id0)/nnz(id1);%./length(xdata);
    [rm,nar2,~] = histw(xdata,ydata,rl,rr);
    
    id0 = EL_RNA0 >= 0.65 & EL_RNA0 <= 0.9 & dxy0 <= r_th & Sp_en_ratio > smin & Sa_en_ratio > smin;
    id1 = EL_RNA1 >= 0.65 & EL_RNA1 <= 0.9;
    xdata = xdata0(id0);
    ydata = 1./Sa_en(id0)./nnz(id1);%./length(xdata);
    [rm,npr,~] = histw(xdata,ydata,rl,rr);
    
    id0 = EL_RNA0 >= 0.65 & EL_RNA0 <= 0.9 & dxy0 > rout_min & dxy0 <= rout_max & Sp_en_ratio > smin & Sa_en_ratio > smin;
    id1 = EL_RNA1 >= 0.65 & EL_RNA1 <= 0.9;
    xdata = xdata0(id0);
    ydata = 1./Sp_en(id0)./nnz(id1);%./length(xdata);
    [rm,npr2,~] = histw(xdata,ydata,rl,rr);
    
    plot(rm,nar,'r','DisplayName','Anterior')
    hold on
    plot(rm,nar2,'r--','DisplayName','Anterior out')
    plot(rm,npr,'b','DisplayName','Posterior');
    plot(rm,npr2,'b','DisplayName','Posterior out');
xlim(xlim5)
% ylim(ylim5)
xlabel('r (pixel)','FontName',nfont,'FontSize',fsize,'FontWeight','normal')
ylabel('#','FontName',nfont,'FontSize',fsize,'FontWeight','normal')
legend('show')
set(gca,'FontName',nfont,'FontSize',fsize2,'FontWeight','normal','Units','normal')
box off
...
%     xdata0 = sqrt(1-(foci_list0(:,2)./foci_list0(:,3)).^2);
    xdata0 = min(foci_list0(:,2:3),[],2)./max(foci_list0(:,2:3),[],2);
    id0 = EL_RNA0 >= 0.10 & EL_RNA0 <= 0.35 & dxy0 <= r_th & Sp_en_ratio > smin & Sa_en_ratio > smin;
    id1 = EL_RNA1 >= 0.10 & EL_RNA1 <= 0.35;
    xdata = xdata0(id0);
    ydata = 1./Sa_en(id0)/nnz(id1);%./length(xdata);
    [em,nar,~] = histw(xdata,ydata,el,er);
    
    id0 = EL_RNA0 >= 0.10 & EL_RNA0 <= 0.35 & dxy0 > rout_min & dxy0 <= rout_max & Sp_en_ratio > smin & Sa_en_ratio > smin;
    id1 = EL_RNA1 >= 0.10 & EL_RNA1 <= 0.35;
    xdata = xdata0(id0);
    ydata = 1./Sp_en(id0)/nnz(id1);%./length(xdata);
    [em,nar2,~] = histw(xdata,ydata,el,er);
    
    id0 = EL_RNA0 >= 0.65 & EL_RNA0 <= 0.9 & dxy0 <= r_th & Sp_en_ratio > smin & Sa_en_ratio > smin;
    id1 = EL_RNA1 >= 0.65 & EL_RNA1 <= 0.9;
    xdata = xdata0(id0);
    ydata = 1./Sa_en(id0)./nnz(id1);%./length(xdata);
    [em,npr,~] = histw(xdata,ydata,el,er);
    
    id0 = EL_RNA0 >= 0.65 & EL_RNA0 <= 0.9 & dxy0 > rout_min & dxy0 <= rout_max & Sp_en_ratio > smin & Sa_en_ratio > smin;
    id1 = EL_RNA1 >= 0.65 & EL_RNA1 <= 0.9;
    xdata = xdata0(id0);
    ydata = 1./Sp_en(id0)./nnz(id1);%./length(xdata);
    [em,npr2,~] = histw(xdata,ydata,el,er);
    
    plot(em,nar,'r','DisplayName','Anterior')
    hold on
    plot(em,nar2,'r--','DisplayName','Anterior out')
    plot(em,npr,'b','DisplayName','Posterior');
    plot(em,npr2,'b','DisplayName','Posterior out');
xlim(xlim6)
% ylim(ylim6)
xlabel('e','FontName',nfont,'FontSize',fsize,'FontWeight','normal')
ylabel('#','FontName',nfont,'FontSize',fsize,'FontWeight','normal')
legend('show')
set(gca,'FontName',nfont,'FontSize',fsize2,'FontWeight','normal','Units','normal')
box off
...
%     xdata0 = sqrt(1-(foci_list0(:,2)./foci_list0(:,3)).^2);
    ...
    xdata0 = (foci_list0(:,9)-theta0)/pi*180;
    id0 = EL_RNA0 >= 0.10 & EL_RNA0 <= 0.35 & dxy0 <= r_th & Sp_en_ratio > smin & Sa_en_ratio > smin;
    id1 = EL_RNA1 >= 0.10 & EL_RNA1 <= 0.35;
    xdata = xdata0(id0);
    ydata = 1./Sa_en(id0)/nnz(id1);%./length(xdata);
    [tm,nar,~] = histw(xdata,ydata,tl,tr);
    
    id0 = EL_RNA0 >= 0.10 & EL_RNA0 <= 0.35 & dxy0 > rout_min & dxy0 <= rout_max & Sp_en_ratio > smin & Sa_en_ratio > smin;
    id1 = EL_RNA1 >= 0.10 & EL_RNA1 <= 0.35;
    xdata = xdata0(id0);
    ydata = 1./Sp_en(id0)/nnz(id1);%./length(xdata);
    [tm,nar2,~] = histw(xdata,ydata,tl,tr);
    
    id0 = EL_RNA0 >= 0.65 & EL_RNA0 <= 0.9 & dxy0 <= r_th & Sp_en_ratio > smin & Sa_en_ratio > smin;
    id1 = EL_RNA1 >= 0.65 & EL_RNA1 <= 0.9;
    xdata = xdata0(id0);
    ydata = 1./Sa_en(id0)./nnz(id1);%./length(xdata);
    [tm,npr,~] = histw(xdata,ydata,tl,tr);
    
    id0 = EL_RNA0 >= 0.65 & EL_RNA0 <= 0.9 & dxy0 > rout_min & dxy0 <= rout_max & Sp_en_ratio > smin & Sa_en_ratio > smin;
    id1 = EL_RNA1 >= 0.65 & EL_RNA1 <= 0.9;
    xdata = xdata0(id0);
    ydata = 1./Sp_en(id0)./nnz(id1);%./length(xdata);
    [tm,npr2,~] = histw(xdata,ydata,tl,tr);
    
    plot(tm,nar,'r','DisplayName','Anterior')
    hold on
    plot(tm,nar2,'r--','DisplayName','Anterior out')
    plot(tm,npr,'b','DisplayName','Posterior');
    plot(tm,npr2,'b','DisplayName','Posterior out');
xlim(xlim7)
% ylim(ylim6)
xlabel('theta','FontName',nfont,'FontSize',fsize,'FontWeight','normal')
ylabel('#','FontName',nfont,'FontSize',fsize,'FontWeight','normal')
legend('show')
set(gca,'FontName',nfont,'FontSize',fsize2,'FontWeight','normal','Units','normal')
box off
...
Npeak = [1,3,6,9,12,15,18]';
Npeak0 = [0,1,3,6,9,12,15]';
Npeak1 = [3,6,9,12,15,18,21]';
% % Npeak = [1:8]';
% % Npeak0 = Npeak-1;
% % Npeak1 = Npeak+1;
...
cmax = [1*ones(size(Npeak)),b0*Npeak+b0*(Npeak1-Npeak)*0.4,b0*2*ones(size(Npeak))]'; cmax = cmax(:)';
...
Icut_min = [0,4.5,7.5,10.5,13.5,16.5,20];
Icut_max = [4.5,7.5,10.5,13.5,16.5,20,30];
