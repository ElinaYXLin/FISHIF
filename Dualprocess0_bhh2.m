function Dualprocess0_bhh2(lf_name)
%% Parameter setting: %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if ~isempty(lf_name)
    list_name=lf_name;
else
...
%             end
    ...
    % %         saveas(63,[result_folder,sub_list{list_J,3}(1:(length(sub_list{list_J,3})-1)),protein_add,bino_add,figure_tail]);
            ...
            save([result_folder,sub_list{list_J,3}(1:(length(sub_list{list_J,3})-1)),mat_tail],'image_folder','image_type','WGA_channel','DAPI_channel','RNA_channel','protein_channel','signal2_channel','resolution','seg_bw','cyto_bw','em_mask','max_image','foci_bw','N_cycle','psize0','g_threshold0','WGA_th0','DAPI_th0','resolutionz','all_color','Nbin','Mdim');
            if time_num==1
                ...
                save([result_folder,sub_list{list_J,3}(1:(length(sub_list{list_J,3})-1)),'.mat'],'image_folder','image_type','WGA_channel','DAPI_channel','RNA_channel','protein_channel','signal2_channel','resolution','seg_bw','cyto_bw','em_mask','max_image','foci_bw','N_cycle','psize0','g_threshold0','WGA_th0','DAPI_th0','resolutionz','all_color','Nbin','Mdim');
            end
