function Dual_all_add4(total_name)
...
for list_I = 1:N1
    ...
    for list_J = 1:M1        
        ...
        mean_S = protein_profile3D_short(nucleus_protein_profile,nucleus_protein_profile_ab,mask_stack,resolution);   %%% protein profile plot (2,22,14,62)
        
        out_name = cat(1,out_name,{image_folder});
        out_data = cat(1,out_data,mean_S);
...
xlswrite([result_folder0,total_name,nu_add,output_tail],out_data_all);
