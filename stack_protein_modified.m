function varargout = stack_protein_modified(varargin)
% STACK_PROTEIN_MODIFIED M-file for stack_protein_modified.fig
%      STACK_PROTEIN_MODIFIED, by itself, creates a new STACK_PROTEIN_MODIFIED or raises the existing
%      singleton*.
%
%      H = STACK_PROTEIN_MODIFIED returns the handle to a new STACK_PROTEIN_MODIFIED or the handle to
%      the existing singleton*.
%
%      STACK_PROTEIN_MODIFIED('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in STACK_PROTEIN_MODIFIED.M with the given input arguments.
%
%      STACK_PROTEIN_MODIFIED('Property','Value',...) creates a new STACK_PROTEIN_MODIFIED or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before stack_protein_modified_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to stack_protein_modified_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help stack_protein_modified

% Last Modified by GUIDE v2.5 15-Sep-2012 16:39:43

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @stack_protein_modified_OpeningFcn, ...
                   'gui_OutputFcn',  @stack_protein_modified_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before stack_protein_modified is made visible.
function stack_protein_modified_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to stack_protein_modified (see VARARGIN)
...
% Choose default command line output for stack_protein_modified
...
% end
% UIWAIT makes stack_protein_modified wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = stack_protein_modified_OutputFcn(hObject, eventdata, handles) 
...
if strcmp(switch_reply,'Yes')
    stack_protein_modified_OpeningFcn(hObject, eventdata, handles)
else
