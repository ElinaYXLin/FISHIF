...
% % % % embryo_name = {'Cad-hb-gal4-22445-2-1M'};
embryo_type = {'bcgal4new'};
embryo_name = {'Bcd-Cad-hb-22445-2-1M_Cad'};
sub_ij = [2,4];
cycle_range = 10:12;
cycle_range2 = 10:12;
rsize0 = 2;
...
EL_range_fluc0 = [0.3,0.7];
EL_range_fluc1 = [0.3,0.7];
...
% % ana_folder = 'Dualprocess6_result/22445-2-1M_FISHIF_hb_gal4_Cad/';
...
% xls_title3 = {'Name','Cycle','h','EL0','Cmax_fit','Cmin_fit','Cmax'};
xls_title3 = {'Name','Cycle','ELh','EL0','Cmax_fit','Cmin_fit','Cmax'};
...
% % expf = @(beta,x) beta(3)*beta(2)^beta(1)./(x.^beta(1)+beta(2)^beta(1))+beta(4);
...
%                 title([sub_list{list_J,3},': Cycle ',num2str(N_cycle)],'interpreter','none')
            ...
            %%% Protein intensity variance vs. mean
            figure(101)
%             ha1 = subplot(sub_ij(1),sub_ij(2),i00);
            ha1 = subaxis(sub_ij(1),sub_ij(2),i00, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
                Itrue0 = (nucleus_protein_profile(:,1) >= EL_range_fluc0(1)) & (nucleus_protein_profile(:,1) <= EL_range_fluc0(2)) & Iz;
...
%%% TX regulation analysis: %%%============================================
            %%% #foci/nu vs. [Protein] for RNA channel
            figure(11)
%             ha1 = subplot(sub_ij(1),sub_ij(2),i00);
            ha1 = subaxis(sub_ij(1),sub_ij(2),i00, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
...
%                 title([sub_list{list_J,3},': Cycle ',num2str(N_cycle)],'interpreter','none')
            ...
            %%% #foci/nu vs. [Protein] for RNA2 channel
            figure(12)
%             ha1 = subplot(sub_ij(1),sub_ij(2),i00);
            ha1 = subaxis(sub_ij(1),sub_ij(2),i00, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
...
%                 title([sub_list{list_J,3},': Cycle ',num2str(N_cycle)],'interpreter','none')
            ...
            %%% #RNA/nu vs. [Protein] for RNA channel
            figure(13)
%             ha1 = subplot(sub_ij(1),sub_ij(2),i00);
            ha1 = subaxis(sub_ij(1),sub_ij(2),i00, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
...
%                 title([sub_list{list_J,3},': Cycle ',num2str(N_cycle)],'interpreter','none')
            ...
            %%% #RNA/nu vs. [Protein] for RNA2 channel
            figure(14)
%             ha1 = subplot(sub_ij(1),sub_ij(2),i00);
            ha1 = subaxis(sub_ij(1),sub_ij(2),i00, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
...
%% Plots of fitting parameters: %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for ii = 1:size(beta_all3,2)
        ha1 = subaxis(1,size(beta_all3,2),ii,1, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
