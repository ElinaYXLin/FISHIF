...
%%% Output: %%%============================================================
        ...
        save([result_folder,sub_list{list_J,3}(1:(length(sub_list{list_J,3})-1)),mat_tail],'em_mask','image_folder','image_type','WGA_channel','DAPI_channel','signal_channel','RNA_channel','signal2_channel','resolution','seg_bw','cyto_bw','max_image','foci_bw','nucleus_profile','foci_profile','cytoplasmic_profile','N_cycle','psize0','g_threshold0','WGA_th0','DAPI_th0');
