...
%% LSM file loading/resave: %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for I_file = 1:length(lsm_name)
        ...
        elseif ~isempty(strfind(input_name,overlay_key))
            bin_size = Nbin;
        else
            bin_size = 1;
        end
    ...
    %%% Image output: %%% -------------------------------------------------
                ...
                if (bin_num <= 2 && isempty(strfind(output_name,overlay_key))) || (bin_num == 1 && ~isempty(strfind(output_name,overlay_key)))
