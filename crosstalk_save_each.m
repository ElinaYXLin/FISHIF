...
%% Construct the crosstalk matrices and output: %%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        for ii = 1:length(all_color0)
            ...
            for jj = 1:length(all_color0)
                ...
                if any(Iin & Iout)
                    p0_mean = mean(cell2mat(P0(Iin & Iout)),1);
        ...
        save([save_folder,sub_list{list_J,I_old_new0}(1:(length(sub_list{list_J,I_old_new0})-1)),mismatch_add,intercept_add,mat_tail],'CrossA','CrossB','all_color0','P0','Cin','Cout')
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
