function [foci_data,fake_data,h,t_absolute,varargout] = dual_local_1(foci_bw00,max_image00,SS,foci_layer,mask_stack,signal_stack,RNA_stack,nucleus_protein_profile,image_folder,N_cycle,varargin)
...
for ir = 1:length(r_size)
    ...
    bw0 = bwlabel(imerode(bwi,strel('disk',r_size(ir)+r_edge)));
