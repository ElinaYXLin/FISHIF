...
%         copyfile([folder_list{list_I,1},out_folder0],[folder_list{list_I,1},out_folder]);
    end
...
%         image_folder = [folder_list{list_I,1},in_folder,sub_list{list_J,3}];
        ...
        image_folder = image_folder0;
        
        protein_channel = sub_num(list_J,14);
...
%         N_cycle = round(log2(max(mask_stack(:))))+2;   %%% Calculate the nuclear cycle number
        ...
        [nucleus_protein_profile,cytoplasmic_protein_profile,quanti_p,nucleus_protein_ab,flip_EL] = protein_profile3D(nucleus_DAPI_profile,max_image,EL_info,protein_channel,mask_stack,signal_stack,image_folder,N_cycle,resolution,resolutionz,[],[],[],[],[],sigmaxyz,flip_axis,EL_range);
...
%         signal_stack = signal_stack/quanti_p(1);
        ...
        [foci_data,fake_data,h,t_absolute,r_size] = dual_local_local3D3(foci_bw00,max_image_list,mask_stack,DNA_mask,signal_stack,RNA_stack,nucleus_protein_profile_ab,image_folder,N_cycle,resolution,resolutionz,[],[],sigmaxyz);
        clear RNA_stack
...
%         [foci_data2,fake_data2,h2,t_absolute2,r_size2] = dual_local_local3D3(foci_bw002,max_image_list2,mask_stack,DNA_mask,signal_stack,signal2_stack,nucleus_protein_profile_ab,image_folder,N_cycle,resolution,resolutionz,foci_mask,[473:477,480,481]);
        [foci_data2,fake_data2,h2,t_absolute2,r_size2] = dual_local_local3D3(foci_bw002,max_image_list2,mask_stack,DNA_mask,signal_stack,signal2_stack,nucleus_protein_profile_ab,image_folder,N_cycle,resolution,resolutionz,[],[473:477,480,481],sigmaxyz);
