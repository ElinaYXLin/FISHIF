function [nucleus_profile,cytoplasmic_profile] = protein_profile(seg_bw,cyto_bw,max_image,signal_channel,image_folder,N_cycle)
...
figure(2)
    ...
    hold off
    title(['Protein concentration profile: ',image_folder,', cycle = ',num2str(N_cycle),' (',subtp,')'])
...
figure(14)
    ...
    title(['Nucleus protein concentration plot: ',image_folder,', cycle = ',num2str(N_cycle),' (',subtp,')'])
