...
for list_I = 1:N1
    ...
    for list_J = 1:M1
        ...
        [mask_stack,signal_stack,RNA_stack] = mask3D(imclearborder(seg_bw),protein_channel,DAPI_channel,RNA_channel,image_folder);
...
%        foci_bw = RNA_seg_manual(seg_bw,max_image,RNA_channel,WGA_channel,resolution,image_folder,N_cycle);
        ...
        [nucleus_protein_profile,cytoplasmic_protein_profile,quanti_p] = protein_profile3(imclearborder(seg_bw),cyto_bw,max_image,protein_channel,mask_stack,signal_stack,image_folder,N_cycle,resolution);
        ...
        [foci_data,fake_data,h,t_absolute,r_size] = dual_local_local(foci_bw00,max_image00(:,:,RNA_channel),SS,foci_layer,mask_stack,signal_stack,RNA_stack,nucleus_protein_profile_ab,image_folder,N_cycle,resolution,4*resolution);
