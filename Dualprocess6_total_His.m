...
% % % % embryo_name = {'Bcd-hb-gal4-22445-2-1M'};
% % % sub_ij = [5,5];
% % % cycle_range = 9:12;
% % embryo_type = {'b'};
...
% % % % % % % % embryo_name = {'h4k5ac-hb-gal4-22445-2-1M'};
% % embryo_type = {'h3gal4new'};
% % embryo_name = {'h3-hb-gal4-22445-2-1M'};
embryo_type = {'h3k27acgal4new'};
embryo_name = {'h3k27ac-hb-gal4-22445-2-1M'};
% % % % embryo_type = {'brgal4new'};
% % % % embryo_name = {'Bcd-rat-hb-gal4-22445-2-1M'};
sub_ij = [4,5];
cycle_range = 9:12;
cycle_range2 = 9:12;
rsize0 = 2;
...
bin_min2 = 0:8:400;   %%% bin_min for [Bcd]
bin_max2 = 16:8:416;   %%% bin_max for [Bcd]
% % % % % % % bin_min2 = 0:2:100;   %%% bin_min for [Bcd]
...
% % % % % ana_folder = 'Dualprocess6_result/09302015_16249-1-5M_FISHIF_hb_gal4_Bcd_05012019/';
% ana_folder = 'Dualprocess6_result/22445-2-1M_FISHIF_hb_gal4_Bcd/';
% % ana_folder = 'Dualprocess6_result/22445-2-1M_FISHIF_hb_gal4_Bcd-rat/';
% % ana_folder = 'Dualprocess6_result/22445-2-1M_FISHIF_hb_Bcd_Cad/';
% % % % ana_folder = 'Dualprocess6_result/22445-2-1M_FISHIF_hb_gal4_h4k5ac/';
ana_folder = 'Dualprocess6_result/22445-2-1M_FISHIF_hb_gal4_h3k27ac/';
...
%% Image analysis: %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    elseif exist([ana_folder,embryo_name{iem},'/',embryo_name{iem},nu_add,foci_add,D3_add,sfit_tail])
        v00 = dir([ana_folder,embryo_name{iem},'/',embryo_name{iem},nu_add,foci_add,D3_add,'*',sfit_tail]);
        for iv = 1:length(v00)
    ...
    elseif exist([ana_folder,embryo_name{iem},'/',embryo_name{iem},nu_add,foci_add,signal2_add,D3_add,sfit_tail])
        v00 = dir([ana_folder,embryo_name{iem},'/',embryo_name{iem},nu_add,foci_add,signal2_add,D3_add,'*',sfit_tail]);
        for iv = 1:length(v00)
            v0 = load([ana_folder,embryo_name{iem},'/',v00(iv).name], '-mat');
            if iv == 1
    ...
    elseif exist([ana_folder,embryo_name{iem},'/',embryo_name{iem},nu_add,fish_add,int_add,D3_add,sfit_tail])
        v00 = dir([ana_folder,embryo_name{iem},'/',embryo_name{iem},nu_add,fish_add,int_add,D3_add,'*',sfit_tail]);
        for iv = 1:length(v00)
            v0 = load([ana_folder,embryo_name{iem},'/',v00(iv).name], '-mat');
            if iv == 1
    ...
    elseif exist([ana_folder,embryo_name{iem},'/',embryo_name{iem},nu_add,fish_add,signal2_add,int_add,D3_add,sfit_tail])
        v00 = dir([ana_folder,embryo_name{iem},'/',embryo_name{iem},nu_add,fish_add,signal2_add,int_add,D3_add,'*',sfit_tail]);
        for iv = 1:length(v00)
            v0 = load([ana_folder,embryo_name{iem},'/',v00(iv).name], '-mat');
            if iv == 1
    ...
    elseif exist([ana_folder,embryo_name{iem},'/',embryo_name{iem},nu_add,foci_add,reg_add,D3_add,sfit_tail])
        v00 = dir([ana_folder,embryo_name{iem},'/',embryo_name{iem},nu_add,foci_add,reg_add,D3_add,'*',sfit_tail]);
        for iv = 1:length(v00)
            v0 = load([ana_folder,embryo_name{iem},'/',v00(iv).name], '-mat');
            if iv == 1
    ...
    elseif exist([ana_folder,embryo_name{iem},'/',embryo_name{iem},nu_add,foci_add,signal2_add,reg_add,D3_add,sfit_tail])
        v00 = dir([ana_folder,embryo_name{iem},'/',embryo_name{iem},nu_add,foci_add,signal2_add,reg_add,D3_add,'*',sfit_tail]);
        for iv = 1:length(v00)
            v0 = load([ana_folder,embryo_name{iem},'/',v00(iv).name], '-mat');
            if iv == 1
    ...
    elseif exist([ana_folder,embryo_name{iem},'/',embryo_name{iem},nu_add,protein_add,int_add,D3_add,sfit_tail])
        v00 = dir([ana_folder,embryo_name{iem},'/',embryo_name{iem},nu_add,protein_add,int_add,D3_add,'*',sfit_tail]);
        for iv = 1:length(v00)
            v0 = load([ana_folder,embryo_name{iem},'/',v00(iv).name], '-mat');
            if iv == 1
    ...
    elseif exist([ana_folder,embryo_name{iem},'/',embryo_name{iem},nu_add,protein_add,fluc_add,D3_add,sfit_tail])
        v00 = dir([ana_folder,embryo_name{iem},'/',embryo_name{iem},nu_add,protein_add,fluc_add,D3_add,'*',sfit_tail]);
        for iv = 1:length(v00)
            v0 = load([ana_folder,embryo_name{iem},'/',v00(iv).name], '-mat');
            if iv == 1
...
%             image_folder = [folder_list{list_I,1},in_folder,sub_list{list_J,3}(1:end-1),old_add,'/'];
            ...
            Izr = (nucleus_protein_profile(:,1) >= EL_range(1)) & (nucleus_protein_profile(:,1) <= EL_range(2)) & Iz;
            ...
            if isempty(fluc_prefit) || size(fluc_prefit,1) < i00 || fluc_prefit(i00,1) <= 0 || all(fluc_prefit(i00,2:end) == 0) || any(isnan(fluc_prefit(i00,2:end)))
...
% % %             nucleus_protein_profile_ab(:,IC) = nucleus_protein_profile_ab(:,IC)/rc_cali;
...
%             ha1 = subplot(sub_ij(1),sub_ij(2),i00);
            ha1 = subaxis(sub_ij(1),sub_ij(2),i00, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
                ...
                if isempty(foci_prefit) || size(foci_prefit,1) < i00 || all(foci_prefit(i00,2:end) == 0) || any(isnan(foci_prefit(i00,2:end)))
...
%             ha1 = subplot(sub_ij(1),sub_ij(2),i00);
            ha1 = subaxis(sub_ij(1),sub_ij(2),i00, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
                ...
                xbin0 = xbin(Itrue);
                ybin0 = ybin(Itrue);
                if isempty(foci2_prefit) || size(foci2_prefit,1) < i00 || all(foci2_prefit(i00,2:end) == 0) || any(isnan(foci2_prefit(i00,2:end)))
                    [rmax,I_max] = max(ybin0);
                    beta0 = [hc0,rmax,0];
                    try
                        [beta1,r,~,~,~] = nlinfit(xbin0,ybin0,@Hill,beta0);
...
%             ha1 = subplot(sub_ij(1),sub_ij(2),i00);
            ha1 = subaxis(sub_ij(1),sub_ij(2),i00, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
                ...
                xbin0 = xbin(Itrue);
                ybin0 = ybin(Itrue);
                if isempty(fish_prefit) || size(fish_prefit,1) < i00 || all(fish_prefit(i00,2:end) == 0) || any(isnan(fish_prefit(i00,2:end)))
                    [rmax,I_max] = max(ybin0);
                    beta0 = [hc0,rmax,0];
                    try
...
%             ha1 = subplot(sub_ij(1),sub_ij(2),i00);
            ha1 = subaxis(sub_ij(1),sub_ij(2),i00, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
                ...
                xbin0 = xbin(Itrue);
                ybin0 = ybin(Itrue);
                if isempty(fish2_prefit) || size(fish2_prefit,1) < i00 || all(fish2_prefit(i00,2:end) == 0) || any(isnan(fish2_prefit(i00,2:end)))
                    [rmax,I_max] = max(ybin0);
                    beta0 = [hc0,rmax,0];
                    try
                        [beta2,r,~,~,~] = nlinfit(xbin0,ybin0,@Hill,beta0);
...
%             ha1 = subplot(sub_ij(1),sub_ij(2),i00);
            ha1 = subaxis(sub_ij(1),sub_ij(2),i00, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
                [xbin,ybin,xerr,yerr,N_in] = equal_dist(nucleus_protein_profile_ab(Iz,1),nucleus_protein_profile_ab(Iz,IC),bin_min,bin_max);
                ...
                if isempty(protein_prefit) || size(protein_prefit,1) < i00 || protein_prefit(i00,1) <= 0 || all(protein_prefit(i00,2:end) == 0) || any(isnan(protein_prefit(i00,2:end)))
                    Itrue11 = Iz & nucleus_protein_profile_ab(:,1) >= EL_range2(1) & nucleus_protein_profile_ab(:,1) <= EL_range2(2);
                    beta1 = [mean(nucleus_protein_profile_ab(Itrue11,IC)),0,0];
                    H_I = beta1;
...
%                 beta_all3 = [beta_all3;beta1];
                plot(nucleus_protein_profile_ab(Iz,1),nucleus_protein_profile_ab(Iz,IC),'.','Color',0.7*ones(1,3),'DisplayName','Data')
                hold on
                errorbarxy(xbin,ybin,xerr,yerr,xerr,yerr,'k','k','.','DisplayName','Binned data');
                plot([xlim0(1):xlim_bin:xlim0(2)],beta1(1)*ones(size([xlim0(1):xlim_bin:xlim0(2)])),'r-','DisplayName','Exp fit');
...
% %                 text(mean(xlimt),mean(ylimt),['C_m = ',num2str(max(nucleus_protein_profile_ab(Iz,IC))/p_protein(1)*p0_protein(1),'%5.2f'),char(10),'C_m_0 = ',num2str(max(nucleus_protein_profile_ab(Iz,IC)),'%5.2f')])
                text(mean(xlimt),mean(ylimt),['C_m = ',num2str(max(nucleus_protein_profile_ab(Iz,IC)),'%5.2f')])
                xlim(xlimt)
                ylim(ylimt)
                xlabel('EL')
                ylabel('[Protein] (nM)')
...
%             ha1 = subplot(sub_ij(1),sub_ij(2),i00);
            ha1 = subaxis(sub_ij(1),sub_ij(2),i00, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
                [xbin,ybin,xerr,yerr,N_in] = equal_bin(nucleus_protein_profile_ab(Izr,IC),nucleus_RNA_profile(Izr,3),Nbin,rover,1);
...
%                     [~,I_middle] = min(abs(ybin(I_max:end)-rmax/2));
                ...
                if isempty(rfoci_prefit) || size(rfoci_prefit,1) < i00 || all(rfoci_prefit(i00,2:end) == 0) || any(isnan(rfoci_prefit(i00,2:end)))
                    try
...
%                         [beta1,r,~,~,~] = nlinfit(xbin(I_fit),ybin(I_fit),Hill1,beta0);
                    ...
                    curve = fit(xbin(I_fit)',ybin(I_fit)', g0, 'StartPoint',beta1,'Upper',5*max(beta1,beta0),'Lower',[0,0,0,0] );
...
%             ha1 = subplot(sub_ij(1),sub_ij(2),i00);
            ha1 = subaxis(sub_ij(1),sub_ij(2),i00, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
                [xbin,ybin,xerr,yerr,N_in] = equal_bin(nucleus_protein_profile_ab(Izr,IC),nucleus_signal2_profile(Izr,3),Nbin,rover,1);
                I00 = ~isnan(xbin) & ~isnan(ybin) & N_in >= N_small;
                xbin = xbin(I00);
                ybin = ybin(I00);
                xerr = xerr(I00);
...
%                     [~,I_middle] = min(abs(ybin(I_max:end)-rmax/2));
                beta0 = [hc1,xbin(I_middle),rmax,0];
                if isempty(rfoci2_prefit) || size(rfoci2_prefit,1) < i00 || all(rfoci2_prefit(i00,2:end) == 0) || any(isnan(rfoci2_prefit(i00,2:end)))
                    try
% %                         [beta1,r,~,~,~] = nlinfit(xbin(I_fit),ybin(I_fit),@Hill,beta0);
%                         [beta1,r,~,~,~] = nlinfit(xbin(I_fit),ybin(I_fit),Hill1,beta0);
                        curve = fit(xbin(I_fit)',ybin(I_fit)', g0, 'StartPoint',beta0,'Lower',[0,0,0,0] );
...
%             ha1 = subplot(sub_ij(1),sub_ij(2),i00);
            ha1 = subaxis(sub_ij(1),sub_ij(2),i00, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
                [xbin,ybin,xerr,yerr,N_in] = equal_bin(nucleus_protein_profile_ab(Izr,IC),nucleus_RNA_profile(Izr,4),Nbin,rover,1);
                I00 = ~isnan(xbin) & ~isnan(ybin) & N_in >= N_small;
                xbin = xbin(I00);
                ybin = ybin(I00);
                xerr = xerr(I00);
...
%                         [beta2,r,~,~,~] = nlinfit(xbin(I_fit),ybin(I_fit),Hill1,beta0);
                    ...
                    curve = fit(xbin(I_fit)',ybin(I_fit)', g0, 'StartPoint',beta2,'Upper',5*max(beta2,beta0),'Lower',[0,0,0,0] );
                    curve.h = beta2(1); curve.c = beta2(2); curve.a = beta2(3); curve.d = beta2(4); 
                end
                beta_all5 = [beta_all5;beta2];
                plot(nucleus_protein_profile_ab(Iz,IC),nucleus_RNA_profile(Iz,4),'.','Color',0.7*ones(1,3),'DisplayName','Data')
                hold on
                errorbarxy(xbin,ybin,xerr,yerr,xerr,yerr,'k','k','.','DisplayName','Binned data');
...
%             ha1 = subplot(sub_ij(1),sub_ij(2),i00);
            ha1 = subaxis(sub_ij(1),sub_ij(2),i00, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
                [xbin,ybin,xerr,yerr,N_in] = equal_bin(nucleus_protein_profile_ab(Izr,IC),nucleus_signal2_profile(Izr,4),Nbin,rover,1);
                I00 = ~isnan(xbin) & ~isnan(ybin) & N_in >= N_small;
                xbin = xbin(I00);
                ybin = ybin(I00);
                xerr = xerr(I00);
...
%                         [beta2,r,~,~,~] = nlinfit(xbin(I_fit),ybin(I_fit),Hill1,beta0);
                ...
                plot(nucleus_protein_profile_ab(Iz,IC),nucleus_signal2_profile(Iz,4),'.','Color',0.7*ones(1,3),'DisplayName','Data')
                hold on
                errorbarxy(xbin,ybin,xerr,yerr,xerr,yerr,'k','k','.','DisplayName','Binned data');
% %                 plot([xlim1(1):xlim_bin1:xlim1(2)],Hill(beta2,[xlim1(1):xlim_bin1:xlim1(2)]),'r-','DisplayName','Hill fit');
%                 plot([xlim1(1):xlim_bin1:xlim1(2)],Hill1(beta2,[xlim1(1):xlim_bin1:xlim1(2)]),'r-','DisplayName','Hill fit');
...
%% TX regulation analysis (all embryos pooled together): %%%%%%%%%%%%%%%%%%
        ...
        ha1 = subaxis(2,N_cycle,I_cycle,1, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
            [xbin,ybin,xerr,yerr,N_in] = equal_bin(nucleus_protein_profile_all(:,IC),nucleus_RNA_profile_all(:,3),Nbin,rover,1);
            I00 = ~isnan(xbin) & ~isnan(ybin) & N_in >= N_small;
            xbin = xbin(I00);
            ybin = ybin(I00);
            xerr = xerr(I00);
...
%             plot([xlim1(1):xlim_bin1:xlim1(2)],Hill1(beta1,[xlim1(1):xlim_bin1:xlim1(2)]),'r-','DisplayName','Hill fit');
        ...
        ha1 = subaxis(2,N_cycle,I_cycle,2, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
            [xbin,ybin,xerr,yerr,N_in] = equal_bin(nucleus_protein_profile_all(:,IC),nucleus_signal2_profile_all(:,3),Nbin,rover,1);
            I00 = ~isnan(xbin) & ~isnan(ybin) & N_in >= N_small;
            xbin = xbin(I00);
            ybin = ybin(I00);
            xerr = xerr(I00);
...
%             plot([xlim1(1):xlim_bin1:xlim1(2)],Hill1(beta1,[xlim1(1):xlim_bin1:xlim1(2)]),'r-','DisplayName','Hill fit');
        ...
        %%% #RNA/nu vs. [Bcd] for RNA channel
        ha1 = subaxis(2,N_cycle,I_cycle,1, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
            [xbin,ybin,xerr,yerr,N_in] = equal_bin(nucleus_protein_profile_all(:,IC),nucleus_RNA_profile_all(:,4),Nbin,rover,1);
            I00 = ~isnan(xbin) & ~isnan(ybin) & N_in >= N_small;
            xbin = xbin(I00);
            ybin = ybin(I00);
            xerr = xerr(I00);
...
%             plot([xlim1(1):xlim_bin1:xlim1(2)],Hill(beta2,[xlim1(1):xlim_bin1:xlim1(2)]),'r-','DisplayName','Hill fit');
        ...
        %%% #RNA/nu vs. [Bcd] for RNA2 channel
        ha1 = subaxis(2,N_cycle,I_cycle,2, 'Spacing', 0, 'PaddingRight',0.03, 'PaddingLeft',0.05, 'PaddingTop',0.03, 'PaddingBottom',0.03, 'MarginLeft', 0.01, 'MarginRight', 0.001, 'MarginTop', 0.015, 'MarginBottom', 0.025);
            [xbin,ybin,xerr,yerr,N_in] = equal_bin(nucleus_protein_profile_all(:,IC),nucleus_signal2_profile_all(:,4),Nbin,rover,1);
            I00 = ~isnan(xbin) & ~isnan(ybin) & N_in >= N_small;
            xbin = xbin(I00);
            ybin = ybin(I00);
            xerr = xerr(I00);
